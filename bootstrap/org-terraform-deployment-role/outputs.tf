output "stack_set_name" {
  description = "Nome do StackSet que cria a role corporativa de execucao Terraform."
...
output "role_name" {
  description = "Nome da role corporativa criada nas contas alvo."
  value       = var.role_name
}

output "management_account_role_arn" {
  description = "ARN da role corporativa criada na management account."
